...
namespace ImageStore.Migrations
{
    ...
    [Migration("20200509114749_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ImageStore.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2020, 5, 9, 11, 47, 48, 717, DateTimeKind.Utc).AddTicks(8496),
                            OrderNumber = "123"
                        });
                });
            ...
            modelBuilder.Entity("ImageStore.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("ImageStore.Data.Entities.Order", b =>
                {
                    b.HasOne("ImageStore.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ImageStore.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
